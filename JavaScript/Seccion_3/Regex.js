/* 
    ...
    con métodos de JavaScript como .match(), .replace() .test() etc..
...
const regex5 = /\d{7}\-\d{5}\-\d{2}\-\d{2}/g;
...
const emailRegex = /\w+\@\w{3,12}\.com/gi; 
...
/* .test()
    Podemos verificar si una cadena de texto contiene una secuencia de caracteres 
    
    En caso de poseerlo retornara true
    y en caso de NO poseerlo retornara false
*/

//Verificar si la expresion se encuentra en el parrafo
// .test() retorna true si la expresion regular encuentra una coincidencia en la busqueda
